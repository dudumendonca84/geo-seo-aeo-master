...
meta: revisto 2026-09-25 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (vigésima sessão consecutiva); novo dado por `WebFetch` directo (contexthints.com, guia de terceiros datado 4 Set, cita o texto oficial da OpenAI) lista só 9 países com conta/billing activa (EUA, Reino Unido, Canadá, Austrália, Nova Zelândia, Japão, Coreia, Brasil, México), Portugal fora dessa lista, pesa para "ainda fechado" sem confirmar; briefing.pt/Cosmo5 sem actualização há um mês. Ver `ai_ads.md`. GPT-6 Sol/Luna (22 Set) e retirement do GPT-5.5 (14 Out) continuam o estado já registado, sem novidade hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: nenhuma mudança de mecânica de citação confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: nenhuma mudança de mecânica confirmada hoje para o Llama aberto; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: parceria de infraestrutura com a Crusoe anunciada 16 Set 2026 (treino/inferência em GPUs dedicadas), sem relevância directa para mecânica de citação; sem mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: Google iniciou o September 2026 spam update a 24 Set 2026 09:15 PDT (quarto spam update do ano, rollout estimado até 2 semanas, sem detalhe técnico divulgado do que mudou): a acompanhar, sem alavanca nova a escrever enquanto não houver detalhe. Continua a descrição do bloco: "Dive deeper" no Discover (18 Set), teste do Knowledge Panel local por "AI Overview" (17 Set), generative UI (19-20 Ago) e expansão dinâmica (27 Ago) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: nenhuma mudança de mecânica confirmada hoje. Watch da Merchant Center (9 Set 2026) sem novidade, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; novidades desta semana (Edge redesign, Excel/Notebooks) são de UX, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: nenhuma mudança confirmada hoje (o assistente "Muse" da Meta Superintelligence Labs continua a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-25 · externo: Ads Manager PT still has no first-hand case on either side (twentieth consecutive session); a new data point via direct `WebFetch` (contexthints.com, a third-party guide dated Sep 4, quoting OpenAI's own availability text) lists only 9 countries with active account/billing (US, UK, Canada, Australia, New Zealand, Japan, Korea, Brazil, Mexico), Portugal not on that list, tilting toward "still closed" without confirming it; briefing.pt/Cosmo5 unchanged for a month. See `ai_ads.md`. GPT-6 Sol/Luna (22 Sep) and the GPT-5.5 retirement (14 Oct) remain the previously recorded state, no news today · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: no confirmed mechanic change today; Grok 4.7 (released 21 Sep, see prior refresh) still has no confirmation that grok.com defaults to it, Deck Builder mapping stays on `grok-4.3`; Grok 4.8 still has no dedicated page · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: Google started the September 2026 spam update on 24 Sep 2026, 09:15 PDT (fourth spam update this year, estimated rollout up to 2 weeks, no technical detail disclosed yet): worth watching, no new lever to write until detail emerges. Block description otherwise unchanged: "Dive deeper" in Discover (18 Sep), local Knowledge Panel "AI Overview" test (17 Sep), generative UI (19-20 Aug) and dynamic expansion (27 Aug) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-25 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant remains the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
