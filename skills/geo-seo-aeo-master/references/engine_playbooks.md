...
- **Pesquisa (augmented)**: o que o motor encontra na web no momento.
  ...
  diretamente: SE Ranking ~300k domínios e Limy.AI 500M+ visitas de bots,
  Ago 2026.)
...
do setor da saúde mede forte nas duas vias. A via onde a marca já ganha
...
- **daily-agent** (diário): absorve mudanças de mecanismo anunciadas pelos
  ...
  por mercado) diretamente nos blocos abaixo.
...
**Marcador de fontes.** O parágrafo "Como decide" pode terminar com
`{{fontes}}`, e o consumidor substitui-o por uma frase com as fontes que
AQUELE motor mais repete nas perguntas DAQUELE cliente, e se o site do
cliente está entre elas. Nasceu da mesma queixa do marcador anterior, um
patamar acima (founder, 4 Set 2026: "como aparecer aqui tá muito genérico,
parece igual pra todos"). E parecia porque era: o mecanismo descrito aqui é
o mesmo para toda a gente, e é suposto ser. O que não é igual é o resultado
dele: na semana de 31 Ago 2026, nas perguntas de um stand de automóveis o
ChatGPT citava deco.proteste.pt, gov.pt e diariodarepublica.pt; nas de uma
consultora de GEO citava developers.google.com e os sites dos concorrentes
diretos. A skill descreve o mecanismo, o Tracker mede o resultado, e o
cartão passa a ter as duas coisas. Conta-se por PERGUNTAS distintas e não
por citações: uma resposta que cita a mesma página quatro vezes não prova
mais do que uma que a cita uma vez. Sem fontes medidas o marcador
desaparece, como os outros. Só faz sentido em motores que pesquisam: um
motor que corre só em memória não tem fontes para mostrar.
...
meta: revisto 2026-09-24 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (décima nona sessão consecutiva); imprensa de publicidade espanhola (~17 Set) reforça, sem confirmar, a leitura "ainda fechado"; Cosmo5 tem agora 10 clientes em Espanha+França, sem activação PT. App ChatGPT Ads para Shopify (lançada 16 Set nos EUA) com expansão à UE anunciada para 23-24 Set, canal distinto do registo directo, sem confirmação de arranque. Comscore (22 Set) mede saturação de anúncios no ChatGPT por categoria: 3%→47% em vídeojogos (Mar→Jun 2026), ver `ai_ads.md`. GPT-6 Sol/Luna (22 Set) e retirement do GPT-5.5 (14 Out) continuam o estado já registado, sem novidade hoje · interno: sem acesso a dados do Tracker nesta sessão
...
5. Mantém uma versão EN atualizada das páginas-pilar: aumenta a presença nas respostas, mas uma página EN desatualizada desempenha pior do que não ter nenhuma [fonte: Search Engine Land, Ago 2026]. {{skip:en-site}}
6. Usa o mesmo nome e a mesma descrição da marca em todas as fontes.
7. Separa conquistado de comprado desde já: os anúncios do ChatGPT entram em 31 mercados europeus (EEE e Suíça) a 24 de Ago 2026, nos planos Free e Go, com Plus/Pro/Business/Enterprise/Education sem anúncios. Não são personalizados no arranque (tema da conversa, localização geral, tipo de dispositivo). Aparecem por baixo da resposta, identificados. Sobre a compra self-serve pelo OpenAI Ads Manager: fontes internacionais (Digiday, CNBC, Forbes) dizem que abriu em beta a 1 Set 2026 nos mesmos 31 mercados (incl. Portugal por herança da lista); fontes portuguesas dedicadas (leak.pt, adclickgroup.com, início de Set 2026) dizem o contrário: os anúncios aparecem, mas a criação direta de campanha continua fechada a anunciantes PT, self-serve descrito como "a chegar nos próximos meses", compra só via equipa OpenAI Ads Solutions ou agências parceiras. **Atualização 7 Set 2026:** a página de elegibilidade da própria OpenAI (help.openai.com/en/articles/20001245) aparenta ter mudado o estado de Portugal para "Available" a 2 Set 2026, segundo dois rastreadores independentes (soku.ai, Unite.AI) que reportam 52 países agora ativos: mas a imprensa portuguesa dedicada não atualizou a sua leitura desde então. **Atualização 8 Set 2026: prazo original chega sem resolução:** dois dados novos reforçam, sem confirmar, o lado "ainda fechado": a Cosmo5 (parceira oficial designada pela OpenAI para a fase alfa em PT/ES) está ela própria ainda só "a preparar" a sua primeira activação doméstica; e uma segunda marca PT, a Robbialac, comprou anúncios no ChatGPT via a agência Social Animals, não por registo direto: o segundo caso PT confirmado, depois da Continente, e o segundo sem tocar no self-serve. Continua sem existir, de nenhum dos dois lados, um único caso em primeira mão de uma conta PT a chegar ao ecrã de criação de campanha ou a ser bloqueada nele. Medir a linha de base conquistada ANTES de haver pago continua a ser o que torna o relatório seguinte interpretável, independentemente de qual leitura se confirmar. [fonte: OpenAI, aviso a utilizadores europeus 15 Ago 2026; Digiday, Dataconomy, TechXplore, 19 Ago 2026; CNBC, Forbes, Digiday, 31 Ago–1 Set 2026; leak.pt e adclickgroup.com, início Set 2026; soku.ai e Unite.AI, 2 Set 2026; briefing.pt sobre a Cosmo5 e a Robbialac/Social Animals, Set 2026: verificação de primeira mão continua pendente, ver alerta]

### claude

meta: revisto 2026-09-24 · externo: sem mudança material desde ontem sobre o Claude Opus 5.5 (lançado 22 Set): uma nova ronda de agregadores de baixa fiabilidade (Latent.Space/AINews, ccleaks.com) repete o claim de default em Claude Code/claude.ai, mas continua sem corroboração das fontes primárias da Anthropic nem de imprensa Tier 1/2: mantido não incorporado, mesmo critério de ontem; sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
2. Escreve páginas que expliquem o que a marca faz em linguagem direta, factual, sem promessas infladas.
...
5. Não presumas que uma boa presença no Claude se transfere para o Claude Code: se um cliente pede visibilidade especificamente no Claude Code (uso interno de developer tooling), é uma medição à parte, com pesquisa web ligada em muito menos respostas.

### gemini

meta: revisto 2026-09-24 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO · interno: sem acesso a dados do Tracker nesta sessão
...
2. Completa o schema.org do site e mantém a ficha Google (Business Profile) atualizada por localização.
3. Cria presença no YouTube: é o domínio mais citado nas respostas de IA da Google [fonte: 22,9% das citações do AI Overviews, Ahrefs, Set 2026; era 20,9% em Jun 2026].
...
meta: revisto 2026-09-24 · externo: nenhuma mudança de mecânica confirmada hoje; o Grok 4.7 (lançado 21 Set, ver refresh anterior) continua sem confirmação de que grok.com o usa por omissão, mapping do Deck Builder mantido em `grok-4.3`; Grok 4.8 continua sem página própria · interno: sem acesso a dados do Tracker nesta sessão
...
4. Não contes com o X como canal de citação garantido no Grok para esta categoria: prioriza o site e fontes indexadas antes de investir tempo em X à espera de citação direta.

### deepseek

meta: revisto 2026-09-24 · externo: DeepSeek decidiu manter o serviço de API do V4 Pro disponível após 14 Set 2026 por procura dos utilizadores, faturação inalterada [fonte: api-docs.deepseek.com/updates]; migração para DeepSeek-V4.1-Flash (`deepseek-flash`) continua sem incidente reportado; sem mudança de mecânica de citação · interno: sem acesso a dados do Tracker nesta sessão

Como decide: memória de treino com forte peso de fontes em inglês; cobertura pt-PT mais fina.

Faz:
1. Publica versão EN das páginas-chave da marca e mantém-na atualizada: uma página EN desatualizada desempenha pior do que não ter nenhuma, porque os modelos a tratam como oficial [fonte: Search Engine Land, Ago 2026]. {{skip:en-site}}
2. Entra em diretórios e listas internacionais da categoria.
3. Usa um nome de marca sem ambiguidade linguística nas fontes EN.

### mistral

meta: revisto 2026-09-24 · externo: nenhuma mudança de mecânica de citação confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
Faz:
1. Trabalha as alavancas de memória: entidade consistente, imprensa durável, presença em fontes europeias da categoria: continuam a valer para o modo base.
2. Mantém conteúdo comparativo e ranking orgânico: vale para o produto de consumo e para os restantes motores augmented.
3. Estrutura páginas para verificação ativa, não só para recuperação: com o Agentic Search o modelo pode abrir e ler o documento inteiro antes de responder, por isso a resposta direta tem de aguentar-se quando o modelo confere a fonte, não só quando a recupera.

### llama

meta: revisto 2026-09-24 · externo: nenhuma mudança de mecânica confirmada hoje para o Llama aberto; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-24 · externo: parceria de infraestrutura com a Crusoe anunciada 16 Set 2026 (treino/inferência em GPUs dedicadas), sem relevância directa para mecânica de citação; sem mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-24 · externo: núcleo update de Agosto da Google terminou o rollout a 21 Set 2026 (26 dias); Comscore (Q2 2026 AI Intelligence Report, 22 Set) mede as AI Overviews em 39,4% das pesquisas desktop dos EUA em Jun 2026 (25,8% em Jul 2025), absorvido em `benchmarks.md` §52. Continua a descrição do bloco: "Dive deeper" no Discover (18 Set), teste do Knowledge Panel local por "AI Overview" (17 Set), generative UI (19-20 Ago) e expansão dinâmica (27 Ago) · interno: sem acesso a dados do Tracker nesta sessão
...
Faz:
1. Abre cada página-chave com um parágrafo-resposta direto, citável isolado.
...
6. Estrutura conteúdo instrucional/comparativo em passos discretos e testáveis: desde por volta de 19-20 Ago 2026 o AIO (não só o AI Mode) pode renderizar "generative UI" (layouts visuais interativos, quizzes) para perguntas que se prestem a isso; conteúdo em passos claros tem mais hipótese de alimentar essa renderização do que prosa corrida [fonte: Search Engine Journal, Ago 2026].

### google_ai_mode

meta: revisto 2026-09-24 · externo: nenhuma mudança de mecânica confirmada hoje. Watch da Merchant Center (9 Set 2026) sem novidade, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-24 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; novidades desta semana (Edge redesign, Excel/Notebooks) são de UX, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
Faz:
1. Garante indexação saudável no Bing: Bing Webmaster Tools ativo e IndexNow ligado. {{skip:bwt-connected}}
...
4. Mantém versão EN atualizada das páginas-pilar: o efeito na presença em respostas de IA é visível também no Copilot [fonte: Search Engine Land, Ago 2026]. {{skip:en-site}}

### meta_ai

meta: revisto 2026-09-24 · externo: nenhuma mudança confirmada hoje (o assistente "Muse" da Meta Superintelligence Labs continua a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-24 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-24 · externo: Ads Manager PT still has no first-hand case on either side (nineteenth consecutive session); Spanish ad-trade press (~17 Sep) reinforces, without confirming, the "still closed" reading; Cosmo5 now has 10 clients across Spain+France, still no PT activation. ChatGPT Ads app for Shopify (launched 16 Sep in the US) has EU expansion announced for 23-24 Sep, a channel distinct from direct self-serve registration, no confirmation it went live. Comscore (22 Sep) measures ChatGPT ad saturation by category: 3%→47% in gaming conversations (Mar→Jun 2026), see `ai_ads.md`. GPT-6 Sol/Luna (22 Sep) and the GPT-5.5 retirement (14 Oct) remain the previously recorded state, no news today · interno: sem acesso a dados do Tracker nesta sessão
...
7. Separate earned from paid starting now: ChatGPT ads roll out to 31 European markets (EEA and Switzerland) on Aug 24, 2026, on Free and Go plans, with Plus/Pro/Business/Enterprise/Education staying ad-free. Not personalized at launch (conversation topic, general location, device type). Shown below the answer, labeled. On self-serve buying through OpenAI Ads Manager: international sources (Digiday, CNBC, Forbes) say it opened in beta on Sep 1, 2026 across the same 31 markets (incl. Portugal, inherited from that list); dedicated Portuguese sources (leak.pt, adclickgroup.com, early Sep 2026) say the opposite: ads are visible, but direct campaign creation is still closed to PT advertisers, self-serve described as "coming in the following months," buying still only through the OpenAI Ads Solutions team or certified agencies. **Update Sep 7, 2026:** OpenAI's own eligibility page (help.openai.com/en/articles/20001245) appears to have flipped Portugal's status to "Available" on Sep 2, 2026, per two independent trackers (soku.ai, Unite.AI) reporting 52 countries now active: but dedicated Portuguese press hasn't updated its reading since then. **Update Sep 8, 2026: the original deadline arrives unresolved:** two new data points reinforce, without confirming, the "still closed" reading: OpenAI's own designated PT/ES alpha-phase partner (Cosmo5) is itself still only "preparing" its first domestic activation; and a second PT brand, Robbialac, bought ChatGPT ads via agency Social Animals, not through direct registration: the second confirmed PT case, after Continente, and the second to bypass self-serve. Still no first-hand case, from either side, of a PT account reaching or being blocked at the campaign-creation screen. Measuring the earned baseline BEFORE paid exists remains what makes the next report interpretable, whichever reading turns out correct. [fonte: OpenAI, notice to EU users Aug 15 2026; Digiday, Dataconomy, TechXplore, Aug 19 2026; CNBC, Forbes, Digiday, Aug 31–Sep 1 2026; leak.pt and adclickgroup.com, early Sep 2026; soku.ai and Unite.AI, Sep 2 2026; briefing.pt on Cosmo5 and Robbialac/Social Animals, Sep 2026: first-hand verification still pending, see alert]

### claude

meta: revisto 2026-09-24 · externo: no material change since yesterday on Claude Opus 5.5 (released 22 Sep): a new round of low-authority aggregators (Latent.Space/AINews, ccleaks.com) repeats the Claude Code/claude.ai default claim, still uncorroborated by Anthropic's own primary sources or Tier 1/2 press: kept unincorporated, same criterion as yesterday; no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
5. Do not assume good Claude presence transfers to Claude Code: if a client specifically asks for Claude Code visibility (internal developer-tooling usage), that is a separate measurement, with web search enabled on far fewer answers.
...
3. Build a YouTube presence: it is the most-cited domain in Google's AI answers [fonte: 22.9% of AI Overviews citations, Ahrefs, Sep 2026; was 20.9% in Jun 2026].
...
meta: revisto 2026-09-24 · externo: no confirmed mechanic change today; Grok 4.7 (released 21 Sep, see prior refresh) still has no confirmation that grok.com defaults to it, Deck Builder mapping stays on `grok-4.3`; Grok 4.8 still has no dedicated page · interno: sem acesso a dados do Tracker nesta sessão
...
Do:
1. Work the memory levers: a consistent entity, durable press, presence in European sources for the category: still valid.
...
3. Structure pages for active verification, not just retrieval: with Agentic Search the model can open and read the whole document before answering, so the direct-answer paragraph has to hold up when the model checks the source, not only when it retrieves it.
...
meta: revisto 2026-09-24 · externo: Google's August core update finished rolling out on 21 Sep 2026 (26 days); Comscore (Q2 2026 AI Intelligence Report, 22 Sep) measures AI Overviews at 39.4% of US desktop searches in Jun 2026 (25.8% in Jul 2025), absorbed into `benchmarks.md` §52. Block description otherwise unchanged: "Dive deeper" in Discover (18 Sep), local Knowledge Panel "AI Overview" test (17 Sep), generative UI (19-20 Aug) and dynamic expansion (27 Aug) · interno: sem acesso a dados do Tracker nesta sessão
...
6. Structure instructional/comparative content into discrete, testable steps: since around Aug 19-20, 2026 AIO (not just AI Mode) can render "generative UI" (interactive visual layouts, quizzes) for questions suited to it; content in clear steps has a better shot at feeding that rendering than running prose [fonte: Search Engine Journal, Aug 2026].
...
meta: revisto 2026-09-24 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant remains the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
