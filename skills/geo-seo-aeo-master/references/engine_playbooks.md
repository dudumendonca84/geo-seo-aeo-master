...
meta: revisto 2026-09-15 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (décima sessão consecutiva); único achado novo é periférico (soku.ai, gap de documentação sobre custom audiences na EEE, não resolve); GPT-6 Astra continua em rollout faseado sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança de mecânica confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: Musk anuncia (X, 13-14 Set) que a xAI abandona o lançamento do Grok 4.7 e passa a treinar o Grok 4.8 (2.5T parâmetros, nova stack C++), a terminar o treino esta semana antes da fase de reforço; sem página de modelo, API ou preço publicados pela xAI. Grok 4.6 continua o modelo de produção, sem mudança de mecânica de citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança de mecânica confirmada hoje; migração para DeepSeek-V4.1-Flash (`deepseek-flash`), executada 14 Set, sem incidente reportado desde então · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança de mecânica de citação confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança de mecânica confirmada hoje para o Llama aberto; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026; sem novidade nesta janela · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança de mecânica confirmada hoje; generative UI (19-20 Ago) e expansão dinâmica (27 Ago) continuam a descrição corrente do bloco, sem achado novo · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança de mecânica confirmada hoje. Watch da Merchant Center (9 Set 2026) sem novidade, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; novidades desta semana (Edge redesign, Excel/Notebooks) são de UX, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança confirmada hoje (o assistente "Muse" da Meta Superintelligence Labs continua a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-15 · externo: Ads Manager PT still has no first-hand case on either side (tenth consecutive session); the only new finding is peripheral (soku.ai, EEA custom-audiences documentation gap, does not resolve it); GPT-6 Astra remains in phased rollout with no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-15 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant remains the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
