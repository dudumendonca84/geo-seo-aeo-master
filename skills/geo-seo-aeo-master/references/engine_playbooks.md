...
meta: revisto 2026-09-11 · externo: aprofundamento, não facto novo, do achado Peec.ai de 4 Set (segunda leitura via `WebSearch`, ainda sem segunda fonte independente nem leitura directa): o índice interno chama-se "Labrador" e o fan-out terá crescido muito desde o GPT-5.6, ver news-feed 11 Set; Ads Manager PT sem dado novo pela sexta sessão consecutiva, incl. o dia sem corrida (10 Set); `WebFetch` a help.openai.com/en/articles/20001245 e ads.openai.com verificado de novo nesta sessão e continua bloqueado (`EGRESS_BLOCKED`); GPT-6 Astra continua em rollout faseado sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança de mecânica confirmada (docs/changelog Anthropic revistos hoje, sem novidade) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança de mecânica confirmada; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO (ai.google.dev changelog revisto hoje) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança: Grok 4.7 continua anúncio verbal de Musk, data reportada 12 Set 2026, ainda sem model card, preço ou API (docs.x.ai e x.ai/news revistos hoje, sem mudança face a ontem) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: novo candidato, não confirmado: dois agentes de research encontraram, só em agregadores (aireleasetracker, llmgateway.io, não a própria DeepSeek), a alegação de um "DeepSeek-V4.1-Flash" lançado a 10 Set 2026 com preço de API reduzido; não confirmado em api-docs.deepseek.com (`WebFetch` bloqueado), tratado como radar, não como facto, mesmo padrão já usado para o Grok 4.7 até haver prova mais forte; nenhuma mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança desde o "Agentic Search" de 20 Ago 2026 (já reflectido no bloco); changelog docs.mistral.ai revisto hoje (OCR 4.1 GA, sem ligação a mecânica de pesquisa/citação) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança de mecânica confirmada para o Llama aberto; ver `models.md` (secção Meta) sobre a nova linha fechada "Muse Spark" da Meta Superintelligence Labs: sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 (changelog docs.perplexity.ai revisto hoje, sem novidade) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: candidato a mudança, não confirmado para o AIO em si: a 8 Set 2026 a Google lançou na EEA um redesenho de SERP para cumprir uma ordem DMA (unidades de agregador/fornecedor para queries de hotel, voo, transporte e produto, após multa de €460M a 23 Jul; cross-corroborado SEJ/SEL/Skift/SE Roundtable). A Comissão Europeia mantém "diálogo em curso" sobre se isto se estende ao AI Overviews; sem confirmação de que o bloco AIO mudou de mecânica hoje. Fora do ICP central (agregadores de viagens/produto, não B2B SaaS): registado como watch, `Faz:` não alterado · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: candidato a mudança, não confirmado para o AI Mode em si: mesmo redesenho DMA de 8 Set 2026 descrito no bloco google_aio (unidades de agregador/fornecedor, EEA, hotel/voo/transporte/produto); CE mantém "diálogo em curso" sobre extensão ao AI Mode, sem confirmação hoje. Candidato anterior de mudança nos ads do AI Mode com datas internamente inconsistentes mantém-se sem segunda fonte: não corroborado, não tratado como facto · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; changelogs Microsoft de Set 2026 revistos hoje são focados em enterprise (SharePoint/OneDrive, Copilot Notebooks), sem mudança ao Copilot consumer · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança confirmada; bloco historicamente sem linha `meta:` própria (gap detectado hoje, corrigido a partir desta corrida) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-11 · externo: a deeper read, not a new fact, of the Sep 4 Peec.ai finding (second pass via `WebSearch`, still uncorroborated by a second source and not read directly): the internal index is named "Labrador" and fan-out reportedly grew a lot since GPT-5.6, see news-feed Sep 11; Ads Manager PT still no new data for the sixth session running, incl. the day with no run (Sep 10); `WebFetch` to help.openai.com/en/articles/20001245 and ads.openai.com was tried again this session and remains blocked (`EGRESS_BLOCKED`); GPT-6 Astra remains in phased rollout with no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-11 · externo: no confirmed change; block historically had no `meta:` line of its own (gap found today, fixed starting this run) · interno: no access to Tracker data this session
