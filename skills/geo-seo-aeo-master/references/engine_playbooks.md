...
meta: revisto 2026-09-23 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (décima oitava sessão consecutiva); via de compra da Discovery Hotel Management (agência ou self-serve) continua por especificar; Cosmo5 continua "a preparar" a activação em Portugal. OpenAI lançou GPT-6 Sol e GPT-6 Luna a 22 Set 2026 (sucessores de geração do GPT-5.6 Sol/Luna, distintos do GPT-6 Astra de 3 Set): disponíveis em ChatGPT Work/Codex, **ainda não no Chat principal** (continua `gpt-5.6-sol` aí); sem mudança de mecânica de citação divulgada. GPT-5.5 retirement anunciado para 14 Out 2026 · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: Anthropic lançou o Claude Opus 5.5 a 22 Set 2026 (leitura directa: platform.claude.com/docs, anthropic.com/claude-opus-5-5), 20% mais barato que o Opus 5 ($4/$20 vs $5/$25), corte de treino em Jun 2026; nenhuma das duas fontes primárias diz se passa a default em algum produto (claim de default no Claude Code/Cowork só em dois blogs de baixa fiabilidade, não incorporado); sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: nenhuma mudança de mecânica de citação confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: nenhuma mudança de mecânica confirmada hoje para o Llama aberto; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: parceria de infraestrutura com a Crusoe anunciada 16 Set 2026 (treino/inferência em GPUs dedicadas), sem relevância directa para mecânica de citação; sem mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: Google testa "Dive deeper" no Discover desde 18 Set 2026 (confirmado pela VP Robby Stein): botão que abre um resumo temático escrito por IA com cartões de fonte, substituindo o artigo/vídeo do publisher, a começar por vídeo; investigadores independentes encontraram sinais de expansão também a cartões de artigo [fonte: Search Engine Roundtable, 20 Set 2026; Search Engine Journal]. É o Discover (feed móvel), não a superfície AI Overview em si, mas o mesmo mecanismo: resumo gerado substitui o clique directo à fonte; ainda teste, não rollout confirmado. Continua a descrição do bloco: teste do Knowledge Panel local por "AI Overview" (17 Set), generative UI (19-20 Ago) e expansão dinâmica (27 Ago) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: nenhuma mudança de mecânica confirmada hoje. Watch da Merchant Center (9 Set 2026) sem novidade, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; novidades desta semana (Edge redesign, Excel/Notebooks) são de UX, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: nenhuma mudança confirmada hoje (o assistente "Muse" da Meta Superintelligence Labs continua a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-23 · externo: Ads Manager PT still has no first-hand case on either side (eighteenth consecutive session); Discovery Hotel Management's purchase channel (agency vs. self-serve) still unspecified; Cosmo5 still "preparing" its Portugal activation. OpenAI launched GPT-6 Sol and GPT-6 Luna on 22 Sep 2026 (generational successors to GPT-5.6 Sol/Luna, distinct from GPT-6 Astra from 3 Sep): available in ChatGPT Work/Codex, **not yet in the main Chat surface** (`gpt-5.6-sol` remains there); no disclosed change to citation mechanics. GPT-5.5 retirement announced for 14 Oct 2026 · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: Anthropic released Claude Opus 5.5 on 22 Sep 2026 (direct fetch: platform.claude.com/docs, anthropic.com/claude-opus-5-5), 20% cheaper than Opus 5 ($4/$20 vs $5/$25), training cutoff Jun 2026; neither primary source states whether it becomes default anywhere (a Claude Code/Cowork default claim appears only on two low-authority blogs, not incorporated); no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: no confirmed mechanic change today; Grok 4.7 (released 21 Sep, see prior refresh) still has no confirmation that grok.com defaults to it, Deck Builder mapping stays on `grok-4.3`; Grok 4.8 still has no dedicated page · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-23 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant remains the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
