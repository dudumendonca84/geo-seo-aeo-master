...
meta: revisto 2026-09-22 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (décima sétima sessão consecutiva); a Discovery Hotel Management (DHM, 5 hotéis) ganhou hoje artigo dedicado no Marketeer, deixando de ser só um nome tentativo num resumo de pesquisa, mas o artigo não foi acedido directamente (`WebFetch` bloqueado) e não especifica via de compra (agência ou self-serve): continua não incorporado como caso confirmado; sem desenvolvimento novo na Cosmo5 (continua "a preparar" a activação em Portugal, dez clientes activos só em Espanha); GPT-6 Astra continua em rollout faseado sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança de mecânica confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: a xAI lançou o Grok 4.7 a 21 Set 2026 (novo modelo topo de gama para código/agentes, mesmo preço do antecessor, contexto 500K), corroborado por 5+ agregadores técnicos independentes, `WebFetch` a docs.x.ai/x.ai bloqueado. Não confirmado se grok.com (o produto medido pelo Tracker) já usa este modelo por omissão: mapping do Deck Builder (`grok-4.3`) mantido sem alteração até confirmação directa. Nota à parte: vários agregadores referem-se ao fornecedor como "SpaceXAI"; sem fonte primária, tratado como não confirmado, não incorporado. Grok 4.8 continua sem página própria · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança de mecânica de citação confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança de mecânica confirmada hoje para o Llama aberto; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: parceria de infraestrutura com a Crusoe anunciada 16 Set 2026 (treino/inferência em GPUs dedicadas), sem relevância directa para mecânica de citação; sem mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança de mecânica confirmada hoje. Watch da Merchant Center (9 Set 2026) sem novidade, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; novidades desta semana (Edge redesign, Excel/Notebooks) são de UX, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança confirmada hoje (o assistente "Muse" da Meta Superintelligence Labs continua a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-22 · externo: Ads Manager PT still has no first-hand case on either side (seventeenth consecutive session); Discovery Hotel Management (DHM, 5 hotels) got a dedicated Marketeer article today, no longer just a tentative name from a search summary, but the article itself was not fetched directly (`WebFetch` blocked) and does not state the purchase channel (agency vs. self-serve): still not incorporated as a confirmed case; no new development on Cosmo5 (still "preparing" its Portugal activation, ten active clients only in Spain); GPT-6 Astra remains in phased rollout with no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: xAI released Grok 4.7 on 21 Sep 2026 (new flagship model for coding/agents, same price as predecessor, 500K context), corroborated by 5+ independent tech aggregators, `WebFetch` to docs.x.ai/x.ai blocked. Not confirmed whether grok.com (the product measured by the Tracker) already defaults to it: Deck Builder mapping (`grok-4.3`) left unchanged pending direct confirmation. Side note: several aggregators refer to the vendor as "SpaceXAI"; no primary-source confirmation, treated as unconfirmed, not incorporated. Grok 4.8 still has no dedicated page · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-22 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant remains the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
