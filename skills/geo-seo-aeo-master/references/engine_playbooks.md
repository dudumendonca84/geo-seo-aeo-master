...
meta: revisto 2026-09-17 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (décima segunda sessão consecutiva), sem achado novo de nenhum dos dois lados; a OpenAI lançou "Sponsored Agents" no ChatGPT (16 Set 2026, anúncio oficial), formato que abre uma conversa patrocinada pela marca em vez de sair para o site, piloto só com anunciantes EUA (Wayfair, Angi), sem data UE/PT; a Comissão Europeia designou o ChatGPT VLOSE ao abrigo do DSA a 31 Ago 2026, o que obriga a OpenAI a publicar um repositório público de anúncios (Artigo 39) até Jan 2027: candidato a fonte first-party nova para medir pago vs. orgânico no ChatGPT na UE, sem acção esta semana; GPT-6 Astra continua em rollout faseado sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança de mecânica confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança de mecânica de citação confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança de mecânica confirmada hoje para o Llama aberto; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: parceria de infraestrutura com a Crusoe anunciada 16 Set 2026 (treino/inferência em GPUs dedicadas), sem relevância directa para mecânica de citação; sem mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança de mecânica confirmada hoje; generative UI (19-20 Ago) e expansão dinâmica (27 Ago) continuam a descrição corrente do bloco, sem achado novo · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança de mecânica confirmada hoje. Watch da Merchant Center (9 Set 2026) sem novidade, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; novidades desta semana (Edge redesign, Excel/Notebooks) são de UX, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança confirmada hoje (o assistente "Muse" da Meta Superintelligence Labs continua a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-17 · externo: Ads Manager PT still has no first-hand case on either side (twelfth consecutive session), no new finding on either side; OpenAI launched "Sponsored Agents" in ChatGPT (Sep 16 2026, official announcement), an ad format that opens a brand-sponsored conversation instead of leaving for the advertiser's site, piloted with US advertisers only (Wayfair, Angi), no EU/PT date; the European Commission designated ChatGPT a VLOSE under the DSA on Aug 31 2026, which requires OpenAI to publish a public ad repository (Article 39) by Jan 2027: a candidate new first-party source for measuring paid vs. organic in ChatGPT in the EU, no action this week; GPT-6 Astra remains in phased rollout with no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-17 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant remains the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
