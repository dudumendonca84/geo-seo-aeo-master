...
meta: revisto 2026-09-12 · externo: sem mudança de mecânica nova hoje (Labrador/fan-out de 4 Set continua sem segunda fonte independente); Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados, mas dois dados novos entram no dossier sem resolver o alerta: a OpenAI nomeou a Adform parceira de tecnologia pan-europeia para ChatGPT Ads (10 Set, Volkswagen/Vodafone como testers, não específico de PT) e um conjunto de sites PT de marketing alega acesso self-serve aberto desde 31 Ago sem nenhum caso real descrito (tratado como não fiável); ver alerta atualizado no news-feed; GPT-6 Astra continua em rollout faseado sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança de mecânica confirmada (docs/changelog Anthropic revistos hoje; relatório de threat intelligence sobre disrupção de uso malicioso do Claude, 11 Set 2026, sem ligação a mecânica de pesquisa/citação) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO (ai.google.dev changelog revisto hoje) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança: no próprio dia em que Musk tinha apontado o lançamento (12 Set 2026), o Grok 4.7 continua por lançar; múltiplos rastreadores independentes (CometAPI, iweaver, orcarouter, BigHat Group) confirmam ausência de model card, preço ou entrada em docs.x.ai à data de hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: DeepSeek-V4.1-Flash (`deepseek-flash`, 10 Set 2026) sobe de candidato fraco para release material corroborado: URL do domínio oficial identificado (api-docs.deepseek.com/news/news260910/, não lido diretamente, `WebFetch` bloqueado) e especificações/preço convergentes em 3+ fontes secundárias independentes; ver `models.md` secção DeepSeek. Migração de tráfego de `deepseek-v4-pro` anunciada para 14 Set 2026, ainda por confirmar por não ter ocorrido. Nenhuma mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança desde o "Agentic Search" de 20 Ago 2026 (já reflectido no bloco); changelog docs.mistral.ai revisto hoje, sem novidade · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança de mecânica confirmada para o Llama aberto hoje; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 (changelog docs.perplexity.ai revisto hoje, sem novidade) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: sem mudança nova hoje ao bloco AIO em si; redesenho DMA de 8 Set 2026 já refletido (SERP clássico, quatro verticais de query, fora do ICP central), CE mantém "diálogo em curso" sobre extensão ao AI Overviews, sem confirmação hoje. `Faz:` não alterado · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: sem mudança nova hoje ao AI Mode em si; redesenho DMA de 8 Set já refletido (ver bloco google_aio), CE mantém "diálogo em curso" sobre extensão ao AI Mode, sem confirmação hoje. Watch de novas secções "AI Performance Insights" no Merchant Center (9 Set 2026, ver `commerce_playbooks.md`): relevante para comércio agentico, sem ligação direta confirmada à mecânica deste bloco · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; changelogs Microsoft revistos hoje, sem novidade ao Copilot consumer · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança confirmada hoje · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-12 · externo: no new mechanism confirmed today (the Sep 4 Labrador/fan-out finding still lacks a second independent source); Ads Manager PT still has no first-hand case on either side, but two new data points enter the file without resolving the alert: OpenAI named Adform its pan-European technology partner for ChatGPT Ads (Sep 10, Volkswagen/Vodafone as brand-side testers, not PT-specific), and a cluster of PT marketing sites claims blanket self-serve access since Aug 31 with no first-hand case described (treated as unreliable); see updated alert in news-feed; GPT-6 Astra remains in phased rollout with no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-12 · externo: no confirmed change today · interno: no access to Tracker data this session
