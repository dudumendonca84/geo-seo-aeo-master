...
meta: revisto 2026-09-14 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (nona sessão consecutiva); mais agregadores terceiros hoje repetem a leitura "Available desde 2 Set" sem caso real associado, sem mudar o estado disputado (ver news-feed e `ai_ads.md`); GPT-6 Astra continua em rollout faseado sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança de mecânica confirmada (Claude Code weekly limits +25%/extensão de promo revistas hoje: produtividade, não retrieval/citação) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: Grok 4.7 continua por lançar; sem novidade além do já registado a 11 Set (Musk: atraso por problema de treino por reforço); Grok 4.6 continua o modelo de produção · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: migração executada como agendado: desde as 04:00 UTC de hoje, `deepseek-v4-pro` passa a responder com o DeepSeek-V4.1-Flash (à tarifa do Flash); o `deepseek-v4-flash` antigo já estava encaminhado para lá desde 10 Set. ID de referência actual: `deepseek-flash`. Sem mudança de mecânica de citação divulgada; ver `models.md` secção DeepSeek e Deck Builder mapping (actualizado hoje) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança de mecânica de citação; notícia do dia (ronda de financiamento de €3 mil milhões, 8 Set) é corporativa, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança de mecânica confirmada para o Llama aberto hoje; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026; sem novidade nesta janela · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: lacuna encontrada na passagem de hoje, não notícia do dia: a Google já tinha expandido, por volta de 19-20 Ago 2026 ("back to school", blog.google), a "generative UI" (layouts visuais interativos, antes só no AI Mode) também para o AI Overviews, com quizzes de prática incluídos: nunca tinha sido absorvido neste bloco. Fonte: Search Engine Journal, corroborado por techwyse.com e storyboard18.com (WebFetch bloqueado). `Faz:` recebe item novo · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: sem mecanismo novo hoje ao AI Mode em si (a generative UI/quizzes absorvida hoje no bloco google_aio já existia primeiro aqui, sem novidade adicional ao AI Mode). Watch da Merchant Center (9 Set 2026) sem novidade hoje, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; novidades desta semana (Edge redesign, Excel/Notebooks) são de UX, sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança confirmada hoje (o assistente "Muse" da Meta Superintelligence Labs continua a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-14 · externo: Ads Manager PT still has no first-hand case on either side (ninth consecutive session); more third-party aggregators today repeat the "Available since Sep 2" reading with no real case attached, not changing the disputed status; see news-feed and `ai_ads.md`; GPT-6 Astra remains in phased rollout with no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-14 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant remains the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
