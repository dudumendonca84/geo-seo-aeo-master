...
meta: revisto 2026-09-13 · externo: Ads Manager PT continua sem caso de primeira mão de nenhum dos dois lados (oitava sessão consecutiva); detalhe novo: as duas marcas PT já confirmadas compraram via as suas próprias agências de meios habituais (Arena Media, Social Animals), não via Cosmo5, o que reenquadra sem resolver o estado disputado (ver news-feed e `ai_ads.md`); GPT-6 Astra continua em rollout faseado sem mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança de mecânica confirmada (docs/changelog Anthropic revistos hoje; sem item novo de retrieval/citação nesta janela) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança de mecânica confirmada hoje; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO (ai.google.dev changelog revisto hoje) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: Grok 4.7 continua por lançar; Musk (11 Set 2026) atribui o atraso a um problema de treino por reforço (penalização excessiva de respostas longas, levando o modelo a abandonar problemas resolúveis) em vez de dar nova data; múltiplos rastreadores independentes confirmam ausência de model card, preço ou entrada em docs.x.ai; Grok 4.6 continua o modelo de produção · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: DeepSeek-V4.1-Flash confirmado por nome de domínio oficial (deepseek.com/en/news/deepseek-v4-1-flash/, ainda não lido diretamente, `WebFetch` bloqueado) por duas pesquisas independentes hoje, não apenas por agregadores; migração de todo o tráfego de `deepseek-v4-pro` para V4.1-Flash mantém-se agendada para as 04:00 UTC de 14 Set 2026 (amanhã), a confirmar na próxima sessão; ver `models.md` secção DeepSeek. Nenhuma mudança de mecânica de citação divulgada · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança de mecânica de citação; changelog docs.mistral.ai revisto hoje mostra uma atualização à OCR API (`include_blocks`) e o Leanstral 1.5, ambos sem ligação a retrieval/citação · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança de mecânica confirmada para o Llama aberto hoje; "Muse Spark" da Meta Superintelligence Labs (linha fechada, ver `models.md`) continua sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 (changelog docs.perplexity.ai revisto hoje, sem novidade); paper de research "Q2D-Web" (9 Set, 70K queries de agente, 190M docs) é awareness, não mudança de mecânica de produto · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: sem mecanismo novo hoje; a Search Engine Roundtable voltou a descrever a 11 Set 2026 (via Robby Stein) o mesmo comportamento já documentado neste bloco desde 27 Ago 2026 (expansão dinâmica do AIO para estado tipo AI Mode sem clique em "Mostrar mais"): reconfirmação, não mecanismo novo. `Faz:` não alterado · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: sem mecanismo novo hoje ao AI Mode em si; mesma reconfirmação de 11 Set (Robby Stein via Search Engine Roundtable) do mecanismo AIO→AI Mode já registado no bloco google_aio, sem detalhe adicional. Watch da Merchant Center (9 Set 2026) sem novidade hoje, ainda não confirmado para PT · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; changelogs Microsoft revistos hoje, sem novidade ao Copilot consumer · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança confirmada hoje (lançamento do assistente "Muse" da Meta Superintelligence Labs, 8-10 Set, é a linha fechada separada, não este Meta AI) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-13 · externo: Ads Manager PT still has no first-hand case on either side (eighth consecutive session); new detail: both confirmed PT brands bought through their own regular media agencies (Arena Media, Social Animals), not through Cosmo5, reframing without resolving the disputed status; see news-feed and `ai_ads.md`; GPT-6 Astra remains in phased rollout with no disclosed change to citation mechanics · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-13 · externo: no confirmed change today (Meta Superintelligence Labs' "Muse" assistant launch, Sep 8-10, is the separate closed product line, not this Meta AI) · interno: no access to Tracker data this session
