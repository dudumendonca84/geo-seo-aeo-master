...
meta: revisto 2026-09-08 · externo: sem mecanismo novo (o teste da Peec.ai de 4 Set mantém-se sem segunda fonte); Ads Manager PT — o prazo original (8 Set, hoje) chega sem resolução, com dois dados novos a reforçar sem confirmar o lado "ainda fechado": a Cosmo5 (parceira oficial da OpenAI para PT/ES) está ela própria só "a preparar" a sua primeira activação, e uma segunda marca PT (Robbialac) comprou via agência, não self-serve · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança de mecânica confirmada (docs/changelog Anthropic revistos hoje, sem novidade) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança de mecânica confirmada; Gemini 3.8 Flash/Flash Cyber continua sem confirmação de default em AI Mode/AIO (ai.google.dev changelog revisto hoje) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança — Grok 4.7 continua anúncio verbal de Musk, data reportada 12 Set 2026, ainda sem model card, preço ou API (docs.x.ai e x.ai/news revistos hoje, sem mudança face a ontem) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança desde o "Agentic Search" de 20 Ago 2026 (já reflectido no bloco); changelog docs.mistral.ai revisto hoje (OCR 4.1 GA, sem ligação a mecânica de pesquisa/citação) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança de mecânica confirmada para o Llama aberto; ver `models.md` (secção Meta) sobre a nova linha fechada "Muse Spark" da Meta Superintelligence Labs — sem impacto no mapping deste motor · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança desde o Hybrid Compute on Mac / PII-TRACE de 1 Set 2026 (changelog docs.perplexity.ai revisto hoje, sem novidade) · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança de mecanismo confirmada na janela de 24-72h · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança confirmada; um candidato a mudança nos ads do AI Mode encontrado com datas internamente inconsistentes entre fontes secundárias — não corroborado, não tratado como facto · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança desde a separação indexação/AI-grounding absorvida a 6 Set 2026; changelogs Microsoft de Set 2026 revistos hoje são focados em enterprise (SharePoint/OneDrive, Copilot Notebooks), sem mudança ao Copilot consumer · interno: sem acesso a dados do Tracker nesta sessão
...
meta: revisto 2026-09-08 · externo: nenhuma mudança ao estado de suspensão · interno: medição suspensa, sem base
...
meta: revisto 2026-09-08 · externo: no new mechanism (the Sep 4 Peec.ai test remains uncorroborated by a second source); Ads Manager PT — the original deadline (Sep 8, today) arrives unresolved, with two new data points reinforcing without confirming the "still closed" reading: OpenAI's own designated PT/ES partner (Cosmo5) is itself still only "preparing" its first activation, and a second PT brand (Robbialac) bought via agency, not self-serve · interno: sem acesso a dados do Tracker nesta sessão
