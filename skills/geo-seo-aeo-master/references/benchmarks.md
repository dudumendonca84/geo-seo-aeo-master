...
---
## 48. Zatuchin: LLM brand citations concentrate in a small set of third-party domains

- **URL.** https://arxiv.org/abs/2606.25787
- **Date.** 25 Jun 2026 (absorbed 12 Sep 2026, before falling out of the 60-day truncation window: reported in `news-feed.md` 2026-07-08, never carried into this file until now).
- **Sample.** 167,551 LLM citations analysed across 128 brands, multiple languages/markets. Single-author arXiv preprint, not peer-reviewed.
- **Finding.** **85.7%** of citations point to third-party domains, not brand-owned properties; **80%** of all citations concentrate in just **18%** of the domains cited.
- **Caveat.** Single-author preprint, not peer-reviewed; multi-language/market sample composition not detailed in available coverage.
- **Use.** Reinforces the case for a "source-domain audit" as a discrete deliverable, not just owned-content GEO work: for a given client's sector/market, mapping which third-party domains carry the most citation weight is where most of the citation opportunity actually sits (pairs with §7 in `frameworks.md`, entity/third-party presence). Awareness for now; evaluate as a named audit line item.

---
## 49. Uberall: review volume beats star rating as a predictor of AI mentions across multi-location brands

- **URL.** https://www.searchenginejournal.com/ai-signals-multi-location-uberall-spa/587988/ (Search Engine Journal, reporting an Uberall study; `WebFetch` blocked this session, found via `WebSearch`)
- **Date.** Early Sep 2026 (exact publication day not confirmed by available coverage; absorbed 13 Sep 2026).
- **Sample.** 120,000+ AI mentions across 3,793 multi-location business listings, 5 AI models (incl. ChatGPT, Perplexity), 5 verticals.
- **Finding.** Review volume predicts a location's odds of being mentioned by an AI model better than star rating does, consistently across all verticals and all 5 models tested. Photo count is the single strongest predictor for restaurants, the strongest signal for dental practices, and the third-strongest for banks.
...
## 52. Comscore: Q2 2026 AI Intelligence Report, engine share shift and AI Overviews reach

- **URL.** GlobeNewswire/ir.comscore.com press release (corroborado por Digiday, Search Engine Journal, Tubefilter); `WebFetch` a comscore.com/globenewswire.com não tentado directamente nesta sessão, achado via `WebSearch` com múltiplas fontes secundárias convergentes.
- **Data.** 22 Set 2026.
- **Amostra.** Painel Comscore de utilizadores desktop/mobile nos EUA, medição de Jan 2025 a Jun 2026 (metodologia proprietária Comscore, não divulgada em detalhe nas fontes secundárias consultadas).
- **Achado.** A fatia do ChatGPT no volume de prompts de IA caiu de 70% (Jan 2026) para 50% (Jun 2026); a do Gemini subiu de 17% para 30%; a do Claude subiu de 2% para 11%. As AI Overviews da Google apareceram em 39,4% das pesquisas desktop dos EUA em Jun 2026 (25,8% em Jul 2025). Uso de assistentes de IA: 35% dos utilizadores desktop e 29% dos móveis nos EUA em Jun 2026 (25%/12% em Jan 2025), crescimento móvel (25 pp) já a ultrapassar o desktop (12 pp) desde início de 2025. ChatGPT: 168M de conversas desktop em Jun 2026, visitação multiplataforma de 59M para 99M num ano. Mesma base de dados mede saturação de anúncios no ChatGPT por categoria (ver `references/ai_ads.md`, secção ChatGPT): 3%→47% em vídeojogos, 5%→24% em brinquedos/hobbies, 9%→22% em livros/música/vídeo (Mar→Jun 2026).
