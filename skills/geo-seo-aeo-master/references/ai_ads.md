...
- **Reconfirmação (28 Ago 2026, prazo do alerta ao founder):** fontes divergem sobre o estado do self-serve para anunciantes PT — uma nota (Mergado/MLQ) sugere abertura "na mesma semana" de 24 ago, mas a cobertura mais detalhada (Index Lab, título explícito "But Not Through Ads Manager Yet") mantém que só um grupo restrito de países (EUA, Canadá, Reino Unido, Austrália, Nova Zelândia, Japão, Coreia do Sul, Brasil, parcialmente México) tem acesso directo — Portugal não está nessa lista. Sem `WebFetch` ou browser autenticado nesta sessão para resolver a divergência em primeira mão; tratado como **estado inalterado** (self-serve PT continua fechado) até confirmação mais forte.
