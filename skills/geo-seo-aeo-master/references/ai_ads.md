...
**Last refresh:** 5 Set 2026 — primeira campanha PT confirmada no ChatGPT (Continente, via agência, não self-serve — ver secção ChatGPT); reforça, sem confirmar, a leitura de que o self-serve continua fechado a anunciantes PT. Refresh anterior: 4 Set 2026, contradição nova entre fontes sobre o estado real do self-serve Ads Manager em Portugal. Refresh anterior a esse: 1 Set 2026, self-serve OpenAI Ads Manager abre para contas UE/PT (gatilho da secção Watch, ver linha 90); refresh anterior a esse: 24 Aug 2026, ChatGPT Ads passou de "lançamento agendado" a "live" em Portugal e nos restantes 30 mercados EEE+Suíça. Mantido pelo daily-agent: o watch "AI ads" em `daily-agent/daily-prompt.md` aponta para este ficheiro. Qualquer mudança de estado (abertura de canal, novo formato, chegada à UE/PT) actualiza a secção do motor E a linha da tabela-resumo, com data.
