...
**Last refresh:** 4 Set 2026 — contradição nova entre fontes sobre o estado real do self-serve Ads Manager em Portugal (ver secção ChatGPT). Refresh anterior: 1 Set 2026, self-serve OpenAI Ads Manager abre para contas UE/PT (gatilho da secção Watch, ver linha 90); refresh anterior a esse: 24 Aug 2026, ChatGPT Ads passou de "lançamento agendado" a "live" em Portugal e nos restantes 30 mercados EEE+Suíça. Mantido pelo daily-agent: o watch "AI ads" em `daily-agent/daily-prompt.md` aponta para este ficheiro. Qualquer mudança de estado (abertura de canal, novo formato, chegada à UE/PT) actualiza a secção do motor E a linha da tabela-resumo, com data.
...
|---|---|---|---|
| ChatGPT | Sim | OpenAI Ads Manager (self-serve — **estado disputado para PT, ver nota**) | Ads live desde 24 Ago 2026 em 31 mercados EEE+Suíça, incl. Portugal (Free e Go); self-serve Ads Manager **reportado** em beta para anunciantes elegíveis nesses mesmos mercados (incl. Portugal), Médio Oriente, Norte de África e Índia desde 1 Set 2026 — mas fontes portuguesas dedicadas (4 Set 2026) dizem que a criação de campanha continua fechada a anunciantes PT; contradição por resolver, ver secção ChatGPT |
...
- **Estado UE anunciantes — DISPUTADO (actualizado 4 Set 2026):** a leitura de 1 Set (hiato fechado, self-serve aberto para os 31 mercados incl. Portugal) já não é o único relato. Fontes portuguesas dedicadas (leak.pt, adclickgroup.com, início de Set 2026, acedidas nesta sessão só via snippet de `WebSearch`, `WebFetch` bloqueado) dizem o oposto: os anúncios aparecem em Portugal desde 24 Ago, mas a criação directa de campanha no Ads Manager continua fechada a anunciantes registados em PT, self-serve descrito como "a chegar nos próximos meses" — compra continua só via equipa OpenAI Ads Solutions ou agências parceiras (Publicis, WPP, Omnicom, MediaPlus, Havas, dentsu). Um artigo (soku.ai, via snippet) tem o título explícito "ChatGPT Ads Expands to 31 European Countries — But Not Through Ads Manager Yet". **Nenhuma das duas leituras (a de 1 Set nem esta) tem confirmação de primeira mão.** Não confirmado nesta sessão: critério exacto de elegibilidade da beta (se existir), e se uma conta PT sem histórico prévio consegue já criar campanha.
